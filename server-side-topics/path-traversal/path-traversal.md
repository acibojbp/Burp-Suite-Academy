...
- [Reading arbitrary files via path traversal](#reading-arbitrary-files-via-path-traversal)
  - [File path traversal, simple case](./lab-01/lab-01.md#file-path-traversal-simple-case)
...
### [**Lab 01 - File path traversal, simple case**](,/lab-01/lab-01.md#file-path-traversal-simple-case)
